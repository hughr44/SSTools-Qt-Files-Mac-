...
void MainWindow::display_pressed()
{
    ...
    if(outfile.open(QFile::WriteOnly | QFile::Text)){
        ...
        errorsFound = "A text file named validationresults.txt has been created with the validation results. To find the file right click the SSTools icon and select Show Package Contents -> MacOS \xa" + errorsFound;
        ui->plainTextEdit->setPlainText(errorsFound);
    }
}
